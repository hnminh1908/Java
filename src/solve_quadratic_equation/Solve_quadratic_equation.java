...
public class Solve_quadratic_equation {
    ...
    public static void main(String[] args) {
        ...
        float a=Solve_quadratic_equation.scanner.nextFloat();
        System.out.print("Nhap he so b: ");
        float b=Solve_quadratic_equation.scanner.nextFloat();
        System.out.print("Nhap he so c: ");
        float c=Solve_quadratic_equation.scanner.nextFloat();
